...
-- Version 2: Fixes column ambiguity by properly qualifying table references
...
-- and properly qualifies table references to avoid ambiguity
...
BEGIN
    ...
    -- Properly qualify the table reference to avoid ambiguity
